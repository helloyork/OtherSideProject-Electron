  ...
  return (
    <div className="flex items-center justify-between px-6 py-3 bg-gray-800 text-white w-full top-0 z-50"
      ...
      <div className="flex items-center gap-4" style={{ "-webkit-app-region": "no-drag" } as any}>
        <Button className="focus:outline-none focus:border-none hover:brightness-75 transition-colors duration-200" color="primary" onClick={handleMinimize}>
          <Minus size={28} />
        </Button>
        <Button className="focus:outline-none focus:border-none hover:brightness-75 transition-colors duration-200" color="primary" onClick={handleMaximize}>
          <Maximize2 size={28} />
        </Button>
        <Button className="focus:outline-none focus:border-none hover:brightness-75 transition-colors duration-200" color="primary" onClick={handleClose}>
          <X size={28} />
        </Button>
      </div>
    </div>
